<!-- <div class="bg-gray-500 text-purple-lighter flex-none w-64 pb-6 hidden md:block">
	<div
	...
	<div class="mb-8">
		...
		<div class="bg-teal-dark cursor-pointer font-semibold py-1 px-4 text-gray-300"># general</div>
	</div>
	<div class="mb-8">
		<div class="px-4 mb-2 text-white flex justify-between items-center">
